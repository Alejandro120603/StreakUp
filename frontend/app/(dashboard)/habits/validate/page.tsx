    ...
    return (
      <div className="pt-8 pb-4 max-w-lg mx-auto px-4 text-center">
        ...
        <button
          ...
          className="text-[#5D5FEF] hover:text-[#7B7DF7] font-medium text-sm"
        >
          ← Volver a hábitos
        </button>
      </div>
  ...
  return (
    <div className="pt-8 pb-4 max-w-lg mx-auto px-4 space-y-6">
      <div className="flex items-center gap-3">
        <button
          onClick={() => router.push("/habits")}
          className="flex items-center justify-center size-10 rounded-xl bg-[#111127] border border-[#2A2A3E] text-muted-foreground hover:text-white hover:border-[#3A3A5E] transition-colors"
        >
          <ArrowLeft className="size-5" />
        </button>
        <div>
          <h1 className="text-2xl font-bold text-white">Validar Hábito</h1>
        ...
        <div className="space-y-4">
          ...
          {!imagePreview ? (
            <button
              ...
              className="w-full rounded-xl border-2 border-dashed border-[#2A2A3E] bg-[#111127] hover:border-[#5D5FEF]/50 hover:bg-[#5D5FEF]/5 p-12 flex flex-col items-center gap-3 transition-all duration-300 group"
            >
              <div className="size-16 rounded-full bg-[#1A1A2E] flex items-center justify-center group-hover:bg-[#5D5FEF]/20 transition-colors">
                <Upload className="size-7 text-muted-foreground group-hover:text-[#5D5FEF] transition-colors" />
              </div>
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl font-semibold text-white transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed bg-[#5D5FEF] hover:bg-[#4B4DDC] shadow-[0_0_20px_rgba(93,95,239,0.3)] hover:shadow-[0_0_28px_rgba(93,95,239,0.5)] active:scale-[0.98]"
          >
      ...
      {status === "loading" && (
        <div className="rounded-xl border border-[#2A2A3E] bg-[#111127] p-8 flex flex-col items-center gap-4">
          <div className="relative">
            <div className="size-16 rounded-full bg-[#5D5FEF]/20 flex items-center justify-center">
              <Loader2 className="size-8 text-[#5D5FEF] animate-spin" />
            </div>
            <div className="absolute inset-0 size-16 rounded-full border-2 border-[#5D5FEF]/20 animate-ping" />
          </div>
          <div className="text-center">
            <p className="text-white font-semibold">Analizando imagen...</p>
